...
<body>
    <div class="content">
        ...
        <div class="page-title">COMPLETED ORDERS</div>
        ...
        <div class="mycart" style="text-align: center; font-family: 'Gabarito', cursive; font-size: 1.5vw; margin-bottom: 2.5vw; margin-top: 3.5vw;">
            <table border="1">
                ...
                $query = "SELECT order_id, cart_id, username, order_time, delivery_address, payment_amount, delivery_status FROM orders WHERE delivery_status = 'Delivered'";
